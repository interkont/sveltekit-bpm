...
<div class="view-container">
	<div class="view-header">
		<button class="back-btn" on:click={goBack}>
			...
			{$_('new_instance.back_to_list')}
		</button>
	</div>
	<div class="title">
		<h2>{$_('new_instance.title_prefix')} {$_(('concepts.instance_singular'))}</h2>
		<p>{$_('new_instance.description', { values: { concept: $_('concepts.process_singular') } })}</p>
	</div>
